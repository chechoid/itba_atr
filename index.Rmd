...
institute: "ITBA - Escuela de Innovación"
date: "30/04/2021"
output:
...
background-image: url(Archivos/atr.png)
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "https://github.com/chechoid/itba_atr") %>% 
  meta_social(
    title = "ATR: A Todo R",
    description = paste(
    ...
    url = "http://dpa-atr.netlify.app",
    image = "https://github.com/cchechoid/itba_atr/blob/main/Archivos/atr.png",
    image_alt = paste(
      "ATR: A Todo R", 
      "Diplomatura de People Analytics ITBA", 
...
* `r emo::ji("wine")` Fundador del [Club de R para RRHH](https://linktr.ee/r4hrclub)
...
No hay recetas mágicas para aprender a codear: requiere tiempo, y mucha práctica, paciencia y persistencia. Sin embargo considero que estos consejos te pueden ser muy útiles:

--
* `r emo::ji("clown")` Hacer proyectos divertidos.
...
options(scipen=999) # Elimina notación científica ejes
...
.pull-left[
`r icons::fontawesome("link")` Presentación: [dpa-atr.netlify.app](http://dpa-atr.netlify.app)
...
`r icons::fontawesome("discord")` [Discord](https://discord.gg/nstkwUaD)
...
---
class: inverse, middle, center
# Recomendacios, Fuentes y créditos
...
En [este link](https://docs.google.com/document/d/1LHOOuQzS_INvUxgHrissdmYafA-Pq7vfJbj1Bx220UQ/edit?usp=sharing) pueden acceder a un documento con algunas guías para comenzar en R y RStudio que utilizo en mis cursos de Introducción a R para RRHH.

También recuerden que tienen a disposición el material del [Club de R para RRHH](https://drive.google.com/drive/folders/1Qck3z_t6XLRXb2vbN-00931DgdJZ0yse?usp=sharing).
...
.pull-left[
Algunas recomendaciones para que el script quede prolijo y:

* Otra persona lo pueda entender.
* Ustedes puedan entender lo que están haciendo
* Ustedes entiendan lo que hicieron 6 meses después de haberlo hecho.

Les dejo un  [artículo en castellano](https://www.maximaformacion.es/blog-dat/primeros-pasos-en-r-guia-de-buenas-practicas/) y un e-book breve escrito por [Hadley Wickham en inglés](https://style.tidyverse.org/)
]

.pull-right[
```{r eval=FALSE}
# Un numeral y 4 guiones hacen un título ------


# Con el numeral hacemos comentarios

# Los comentarios ayudan a otros a entender lo que hacemos


# Dejen espacios


# Nombres de objetos claros
prnl <- read.csv("personal.csv") # Mal

personal <- read.csv("personal.csv") # Bien
...
* [Libro Vivo de Ciencias de Datos](https://librovivodecienciadedatos.ai/) de Pablo Casas
* [R para Ciencias de Datos](https://es.r4ds.hadley.nz/) de Hadley Wickham y Garrett Grolemund

## En inglés

* [Handbook of Regression Modeling in People Analytics](http://peopleanalytics-regression-book.org/) de Keith McNulty.
* [YaRrr! The Pirate’s Guide to R](https://bookdown.org/ndphillips/YaRrr/) de Nathaniel D. Phillips.

---
# Créditos

Yanina Bellini Saibene "On programming, teaching, and building tutorials with learnr | RStudio", [RStudio Conf 2021](https://youtu.be/EBAvQkP9Kyc)

Tidy Tuesday, "Wine ratings" dataset: https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-05-28

### Paquetes
**metallicaRt**: Colour palettes based on Metallica studio album covers. R package version 0.0.0.9000., https://github.com/johnmackintosh/metallicaRt

**gameofthrones**: Alejandro Jimenez Rico (2021). gameofthrones: Palettes Inspired in the TV Show "Game of Thrones". R package version 1.0.2. https://github.com/aljrico/gameofthrones

**brickr**: Ryan Timpe (2020). brickr: Emulate LEGO Bricks in 2D and 3D. R package version 0.3.5. https://CRAN.R-project.org/package=brickr

**ggbernie**: R CODER (2021). ggbernie: A Geom for Adding Bernies. R package version 1.0.

**noah**: Tobias Busch (2021). noah: Create Unique Pseudonymous Animal Names. R package version 0.1.0. https://CRAN.R-project.org/package=noah
...
[Repo en GitHub](https://github.com/chechoid/itba_atr)
